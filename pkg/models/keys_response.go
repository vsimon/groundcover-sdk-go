...
func (m *KeysResponse) validateKeys(formats strfmt.Registry) error {
...
func (m *KeysResponse) contextValidateKeys(ctx context.Context, formats strfmt.Registry) error {

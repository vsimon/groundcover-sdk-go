...
// KnownPipelines KnownPipelines is a map of template names to pipeline templates
...
// ContextValidate validate this known pipelines based on the context it is used
func (m KnownPipelines) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

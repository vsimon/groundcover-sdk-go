...
func (o *UpdateConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /api/remote-config/logs-pipeline] updateConfig", response, response.Code())
	}
}
...
func (o *UpdateConfigOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/remote-config/logs-pipeline][%d] updateConfigOK %s", 200, payload)
}
...
func (o *UpdateConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/remote-config/logs-pipeline][%d] updateConfigBadRequest %s", 400, payload)
}
...
func (o *UpdateConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/remote-config/logs-pipeline][%d] updateConfigInternalServerError %s", 500, payload)
}

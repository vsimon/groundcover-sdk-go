...
func (o *GetConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api/remote-config/logs-pipeline] getConfig", response, response.Code())
	}
}
...
func (o *GetConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/remote-config/logs-pipeline][%d] getConfigOK %s", 200, payload)
}
...
func (o *GetConfigNoContent) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/remote-config/logs-pipeline][%d] getConfigNoContent %s", 204, payload)
}
...
func (o *GetConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/remote-config/logs-pipeline][%d] getConfigInternalServerError %s", 500, payload)
}

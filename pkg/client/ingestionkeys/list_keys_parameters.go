...
// WithBody adds the body to the list keys params
func (o *ListKeysParams) WithBody(body *models.ListIngestionKeysRequest) *ListKeysParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list keys params
func (o *ListKeysParams) SetBody(body *models.ListIngestionKeysRequest) {
	o.Body = body
}

...
// WithID adds the id to the get silence params
func (o *GetSilenceParams) WithID(id string) *GetSilenceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get silence params
func (o *GetSilenceParams) SetID(id string) {
	o.ID = id
}

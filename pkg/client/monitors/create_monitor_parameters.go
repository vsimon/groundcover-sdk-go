...
func (o *CreateMonitorParams) WithBody(body *models.CreateMonitorRequest) *CreateMonitorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create monitor params
func (o *CreateMonitorParams) SetBody(body *models.CreateMonitorRequest) {
	o.Body = body
}

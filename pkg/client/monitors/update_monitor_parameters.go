...
func (o *UpdateMonitorParams) WithBody(body *models.UpdateMonitorRequest) *UpdateMonitorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update monitor params
func (o *UpdateMonitorParams) SetBody(body *models.UpdateMonitorRequest) {
	o.Body = body
}

// WithID adds the id to the update monitor params
func (o *UpdateMonitorParams) WithID(id string) *UpdateMonitorParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update monitor params
func (o *UpdateMonitorParams) SetID(id string) {
	o.ID = id
}

...
type ClientService interface {
	GetDiscovery(params *GetDiscoveryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetDiscoveryOK, error)

	GetKeys(params *GetKeysParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetKeysOK, error)

	GetValues(params *GetValuesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetValuesOK, error)
...
func (a *Client) GetDiscovery(params *GetDiscoveryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetDiscoveryOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getDiscovery",
		Method:             "POST",
		PathPattern:        "/api/search/discovery",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetDiscoveryReader{formats: a.formats},
		AuthInfo:           authInfo,
